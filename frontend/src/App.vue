...
const searchItems = [
  ...
  { name: '代码混淆', path: '/devtools/obfuscator', category: '开发工具', icon: 'Lock' },
  ...
  { name: '加密解密', path: '/devtools/crypto', category: '开发工具', icon: 'Shield' },
  { name: 'XML 工具', path: '/devtools/xml', category: '开发工具', icon: 'Code2' },
  { name: '二维码', path: '/devtools/qrcode', category: '开发工具', icon: 'QrCode' },
  { name: '文本工具', path: '/devtools/text', category: '开发工具', icon: 'FileText' },
  { name: '进制转换', path: '/devtools/radix', category: '开发工具', icon: 'Binary' },
  { name: '占位文本生成', path: '/devtools/dummydata', category: '开发工具', icon: 'Database' },
  { name: '接口文档生成', path: '/devtools/apidoc', category: '开发工具', icon: 'FileCode' },
  { name: '代码片段', path: '/devtools/snippets', category: '开发工具', icon: 'BookMarked' },
  { name: 'JSON 对比', path: '/devtools/jsondiff', category: '开发工具', icon: 'GitCompare' },
  // sysinfo
  { name: '系统信息', path: '/sysinfo/sysinfo', category: '系统工具', icon: 'Monitor' },
  { name: '进程管理', path: '/sysinfo/process', category: '系统工具', icon: 'Cpu' },
  { name: '端口查看', path: '/sysinfo/ports', category: '系统工具', icon: 'Network' },
  { name: '磁盘清理', path: '/sysinfo/diskcleaner', category: '系统工具', icon: 'Trash2' },
  { name: '批量重命名', path: '/sysinfo/rename', category: '系统工具', icon: 'FilePen' },
  { name: '文件批量处理', path: '/sysinfo/filebatch', category: '系统工具', icon: 'FolderSearch' },
  { name: '图片工具', path: '/sysinfo/imagetool', category: '系统工具', icon: 'Image' },
  ...
  { name: 'Ping 测试', path: '/network/ping', category: '网络工具', icon: 'Signal' },
  { name: 'DNS 查询', path: '/network/dns', category: '网络工具', icon: 'Globe2' },
  { name: 'WHOIS 查询', path: '/network/whois', category: '网络工具', icon: 'SearchCode' },
  ...
  { name: 'Hosts 编辑', path: '/network/hosts', category: '网络工具', icon: 'Server' },
  // settings
